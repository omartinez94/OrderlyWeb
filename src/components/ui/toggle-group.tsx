 ...
 *
 * The inline `style` on the root sets a single CSS custom property
 * (`--gap`) from the `spacing` prop — the only way to bridge a
 * dynamic React value into a CSS custom property without a stylesheet.
 * This matches the AGENTS.md exception for dynamic values that cannot
 * be expressed in CSS.
 */
...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive.Root
      ...
      className={cn("group/toggle-group flex w-fit items-center gap-[--gap] rounded-md", className)}
      {...props}
    >
