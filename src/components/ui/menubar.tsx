...
/**
 * Menubar — horizontal tool palette.
 *
 * Used for complex application surfaces (the KDS, the back-office
 * editor) where the user is in a work mode and needs a stable
 * surface. Not for top-level marketing navigation — use
 * `NavigationMenu` for that.
 *
 * Visual contract:
 *   - The bar sits on `bg-surface` (the page surface) with a
 *     1px `border-strong` ring, no shadow.
 *   - Triggers are transparent; hover/active lifts to
 *     `bg-surface-elevated`.
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center rounded-sm px-2 py-1 text-sm font-medium select-none outline-none",
  ...
  return (
    <MenubarPortal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[12rem] overflow-hidden rounded-md border border-border-subtle bg-popover p-1 text-ink shadow-md",
...
function MenubarSubContent({
  ...
  return (
    <MenubarPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-md border border-border-subtle bg-popover p-1 text-ink shadow-lg",
        "data-[side=bottom]:slide-in-from-top-2",
        "data-[side=left]:slide-in-from-right-2",
        "data-[side=right]:slide-in-from-left-2",
        "data-[side=top]:slide-in-from-bottom-2",
