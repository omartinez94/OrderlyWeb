...
/**
 * DropdownMenu — keyboard-accessible menu triggered by a button.
 *
 * Common contract (Radix-handled):
 *   - Arrow keys move between items; Home/End jump to first/last.
 *   - Typeahead jumps to the next matching item.
 *   - Escape closes and returns focus to the trigger.
 *   - Sub-menus open on hover/right-arrow and close on left-arrow.
 *   - One DropdownMenu is open at a time across the app — opening
 *     a new one closes any other.
 */
